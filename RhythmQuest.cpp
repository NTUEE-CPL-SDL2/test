...
const uint64_t MS_PER_FRAGMENT;
std::string MOD;
std::unordered_map<std::string, mystd::tuple<ModFunc, ModFunc, SettingsFunc>> &modEntry;
...
void showSettings() {
  ...
  FRAGMENTS = 10;
  MS_PER_FRAGMENT = 100;
  MOD = "Game of Life (hold notes counted as alive cell, before new fragments load)";
  modEntry = mods::getModMap()[MOD];
  modSettingsFunc = mystd::get<2>(modEntry);
